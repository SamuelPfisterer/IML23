...
def make_feature_extractor(x, y, batch_size=256, eval_size=1000):
    ...
    def make_features(x):
        ...
        """
        model.eval()
        # TODO: Implement the feature extraction, a part of a pretrained model used later in the pipeline.v
        return x
...
if __name__ == '__main__':
    ...
    pipe = Pipeline(steps = [('extractor', PretrainedFeatureClass), ('final', regression_model)])
